...
const HeaderGraphic = () => {
  return (
    <section className={styles.icons}>
      ...
      <RiSettings4Fill style={{ left: '64%', top: '35.5%', height: '6%'}} color='#8fc6c5'/>
      <GiMountainClimbing style={{ left: '56.5%', top: '35.7%', height: '8%'}} color='#5b7f5a'/>
      <BsClock style={{ left: '58.5%', top: '30.6%', height: '5%'}} color='#ba970b'/>
      <FaFolder style={{ left: '64%', top: '29.6%', height: '7%'}} color='#69b3ef'/>
      ...
      <HiOutlineCode style={{ left: '63.5%', top: '13.5%', height: '7.5%'}} color='#bfc9c9'/>
      <IoIosSunny style={{ left: '70%', top: '12.5%', height: '7%'}} color='#e0d738'/>
      <FaRunning style={{ left: '65%', top: '8%', height: '6%'}} color='#6e8e65'/>
      <FaBook style={{ left: '70.5%', top: '7%', height: '6%'}} color='#2aadbf'/>
