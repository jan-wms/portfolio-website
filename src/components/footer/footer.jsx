    ...
    <footer className={styles.footer} id='footer'>
      <section className={styles.content}>
        ...
        <section className={styles.linkSection}>
          <a className={styles.link} href='https://www.github.com/jan2210/' target="_blank" rel="noreferrer nofollow" title='Github'><VscGithub className={styles.icon} /><p>Github</p></a>
          ...
          <a className={styles.link} href='https://janw.netlify.app' target="_blank" rel="noreferrer nofollow" title='App Store'><SiAppstore className={styles.icon} /><p>App Store</p></a>
        </section>
      </section>
